...
if [[ ${KUBE_NAMESPACE} == ${BRANCH_ENV} ]]; then
  ...
  export REVOCATION_URL="https://acp-sso.notprod.acp.homeoffice.gov.uk/realms/rotm-dev/protocol/openid-connect/logout"
  ...
  export REVOCATION_URL="https://sso.digital.homeoffice.gov.uk/auth/realms/rotm/protocol/openid-connect/logout"
  # NOTE: The discovery + revocation URL for prod will also be changed once ACP have upgraded our keycloak production realm
  $kd -f kube/file-vault/file-vault-ingress.yml
  $kd -f kube/configmaps/configmap.yml  -f kube/app/service.yml
