...
describe('apps/rotm \'check-report\' behaviour should ', () => {
    ...
    describe('The configure method ', () => {
        ...
        it('deletes contact section from form if user selects no', () => {
