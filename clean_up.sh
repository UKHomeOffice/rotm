...
export IGNORE_SECRET=("branch-tls-external" "branch-tls-internal" "aws" "keycloak-client" "keycloak-user" "passwordhash" "redis" "rotm-notprod-s3" "rotm-session" "s3-bucket")
